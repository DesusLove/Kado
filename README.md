<div align="center">
  <a href="https://getkado.app/">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="branding/kado-wordmark-dark.svg" />
  ...
  <p>
    <a href="https://github.com/DesusLove/Kado/blob/main/LICENSE"><img alt="MIT license" src="https://img.shields.io/badge/license-MIT-blue.svg" /></a>
...
```bash
git clone https://github.com/DesusLove/Kado.git
cd kado
open Kado.xcodeproj
```
...
[MIT](./LICENSE) © 2026 Kunta Solomon Dongo.
